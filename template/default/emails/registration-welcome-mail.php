              ...
              "brdBottomPadd-two" id="templateContainer" width="100%">
                <tr>
                  <td class="bodyContent" valign="top" mc:edit="welcomeEdit-02">
                    ...
                    <h1><strong>Welcome onboard<br>
                    at <?=$this->name;?>!</strong></h1>

                    <h3>You have successfully gone through the process of registration at <?=$this->name;?>.</h3>
                    <p>We wish you all the very best for upcoming journey with us. Have a great success and growth ahead.
                    ...
                    <table border="0" cellpadding="0" cellspacing="0">
                      <tr>
                        ...
                        "top" mc:edit="welcomeEdit-04">
                          ...
                          <h5>Community Manager at <?=$this->name;?></h5>
                        </td>
                      </tr>
                    </table>
                  </td>
