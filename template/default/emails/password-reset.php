              ...
              "templateContainerMiddleBtm" width="100%">
                <tr>
                  <td class="bodyContent" valign="top" mc:edit="welcomeEdit-11">
                    ...
                    <h4>You have received this email because you initiated a password reset for your account with us. If untrue, Ignore this mail.</h4><a class="blue-btn" href="<?=@$data['reset_link'];?>"><strong>Reset Password
                    </strong></a>
                  </td>
                </tr>
              </table><!-- // END BODY -->
